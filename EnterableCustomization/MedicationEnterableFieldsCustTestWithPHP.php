        ...
        <table id="medTable">
             ...
             */
                ...
                foreach ($_SESSION['medList'] as $item) {
                    ...
                    echo "<form action=" . htmlspecialchars($_SERVER['PHP_SELF']) . " method='get' name='remove'><input type='hidden' name='number' value=" . $number . "><button type='submit' name='remove' id='confirm' value='$number' disabled='disabled'>Delete</button></form>";
                ...
                if (isset($_GET['remove'])) {
                    ...
                    echo "<form action=" . htmlspecialchars($_SERVER['PHP_SELF']) . " method='get' name='confirm'><input type='hidden' name='number' value=" . $number . "><button type='submit' name='confirm' id=" . $number . "confirm" ." value='-1'>Confirm</button></form>";

//                    echo "<form action=" . header('Location: MedicationEnterableFieldsCustTestWithPHP.php') . " method='get' name='cancel'><input type='hidden' name='number' value=" . $number . "><button type='submit' name='cancel' id=" . $number . " value='-1'>Cancel</button></form>";

                    echo "<button><a href='MedicationEnterableFieldsCustTestWithPHP.php'>Cancel</a></button>";
             ...
             */
            } else if (isset($_SERVER['SCRIPT_FILENAME']) && isset($_SESSION['medList'])) {
                foreach ($_SESSION['medList'] as $item) {
                    printRows($item);
                }
    ...
    <script type="text/javascript">
        ...
        $('#drugName').autocomplete({
            source: [ 'Aspirin PO 5MG', 'Methylprednisolone', 'Advair', 'Fentanyl', 'Flonase', 'Zyrtec', 'Day Quill']
        });
